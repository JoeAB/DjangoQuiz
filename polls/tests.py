...
class QuesionModelTests(TestCase):
	...
	def test_was_published_recently_with_future_question(self):
		...
		future_question = Question(publish_date=time, category_id =1)
...
class QuestionIndexViewTests(TestCase):
	...
	def test_no_questions(self):
		...
		response = self.client.get(reverse('polls:questionList'))
...
def create_question(question_text, days):
	...
	return Question.objects.create(question_text=question_text, publish_date=time, category_id =1)